...
\adencIfPset{%
  \declaretheorem[style = psetprobbox, name = Problem, sibling = theorem, qed = \probqed]{problem}
  \declaretheorem[style = psetprobbox, name = Problem, numbered = no, qed = \probqed]{problem*}
}{%
