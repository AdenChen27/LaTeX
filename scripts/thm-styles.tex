...
\adencIfBoxed{%
  ...
  % No end symbols for definition, example, remark, and problem
  \newcommand\defqed{}
  \newcommand\remqed{}
  \newcommand\exqed{}
  \newcommand\probqed{}
  ...
  % End symbols for definition, example, and remark
  \adencIfFancyqed{%
    \newcommand\defqed{\faLaravel}
    \newcommand\remqed{\Coffeecup}
    \newcommand\exqed{\Faxmachine} % \Telefon
    \newcommand\probqed{\WritingHand}
  }{%
    \newcommand\defqed{\(\square\)}
    \newcommand\remqed{\(\diamond\)}
    \newcommand\exqed{\(\vartriangleleft\)}
    \newcommand\probqed{\(\scriptstyle\triangle\)}
  }
}
...
\declaretheorem[style = \defboxStyle, name = Definition, sibling = theorem, qed = \defqed]{definition}
\declaretheorem[style = \defboxStyle, name = Definition, numbered = no, qed = \defqed]{definition*}
...
\adencIfPset{%
  \declaretheorem[style = psetprobbox, name = Problem, sibling = theorem]{problem}
  \declaretheorem[style = psetprobbox, name = Problem, numbered = no]{problem*}
}{%
...
{
  \tcolorboxenvironment{problem}{adenc~psetprobbox}
  \tcolorboxenvironment{problem*}{adenc~psetprobbox}
}
